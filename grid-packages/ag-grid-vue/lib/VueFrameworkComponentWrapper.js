...
const BaseComponentWrapper = require("ag-grid-community").BaseComponentWrapper;
const Bean = require("ag-grid-community").Bean;
const VueComponentFactory = require("./VueComponentFactory").VueComponentFactory;
...
module.exports = { VueFrameworkComponentWrapper };
